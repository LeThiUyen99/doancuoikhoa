            ...
            <div class="ftco-search d-flex justify-content-center">
              <div class="row">
                <div class="col-md-12 nav-link-wrap">
                  <div id="v-pills-tab" class="nav nav-pills text-center" role="tablist" aria-orientation="vertical">
                    <a id="v-pills-1-tab" class="nav-link active mr-md-1" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Search Tour</a>

                    <a id="v-pills-2-tab" class="nav-link" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">Hotel</a>
                ...
                <div class="col-md-12 tab-wrap">
                  ...
                  <div id="v-pills-tabContent" class="tab-content">
                    ...
                    <div id="v-pills-1" class="tab-pane fade show active" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                      <el-form action="#" class="search-property-1">
                        <div class="row no-gutters">
                          <div class="col-md d-flex">
                            <div class="form-group p-4 border-0">
                              <label for="#">Destination</label>
                              <div class="form-field">
                                <div class="icon"><span class="fa fa-search" /></div>
                          ...
                          <div class="col-md d-flex">
                            <div class="form-group p-4">
                              ...
                              <div class="form-field">
                                <div class="icon"><span class="fa fa-calendar" /></div>
                            ...
                            <div class="form-group p-4">
                              ...
                              <div class="form-field">
                                <div class="select-wrap">
                                  <div class="icon"><span class="fa fa-chevron-down" /></div>
                    ...
                    <div id="v-pills-2" class="tab-pane fade" role="tabpanel" aria-labelledby="v-pills-performance-tab">
...
.btn.btn-primary {
  background: #c3a30b !important;
  border: 1px solid #c3a30b !important;
  color: #fff !important; }
