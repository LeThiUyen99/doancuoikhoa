  ...
  <el-row class="body-data">
    <el-row v-if="!isShowUser">
      ...
      >
        ...
        >
          <template slot-scope="props">
            <template v-if="props.row.golfer"><el-link @click="onUserDelivery(props.row.golfer)">{{ `${props.row.golfer.name} - VGA${props.row.golfer.id}` }}</el-link></template>
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="props">
            ...
            <template v-if="props.row.state < 3">
              ...
              <el-button v-if="is_delete" size="small" :title="$t('cancel_order')" type="danger" icon="el-icon-close" circle @click="showDialogCancelOrder(props.row)" />
            </template>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-row v-if="isShowUser">
      <user-v-g-a :table-data-user="tableDataUser" :loading-table-user="loadingTableUser" :state-user="stateUser" />
    </el-row>
