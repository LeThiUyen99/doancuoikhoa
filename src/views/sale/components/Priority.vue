      ...
      >
        ...
        >
          <template slot-scope="props">
            <template>{{ props.row.priority }}</template>
          </template>
        </el-table-column>
...
import DialogFormPriority from '@/views/sale/components/DialogFormPriority'
...
export default {
  name: 'Priority',
  components: { DialogFormPriority, DetailSale },
  props: {
    state: {
      type: Number,
      default() {
